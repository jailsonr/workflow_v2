...
//		}
	...
	public static final HashMap<String, StatusStrategy> getInstatiatedStatusClasses() throws ClassNotFoundException, InstantiationException, IllegalAccessException {
            ...
            if (directory.exists()) {
                ...
                for (String file : files) {
                    ...
                    if (file.endsWith(".class")) {
                      ...
                      try
                      {
                        classes.put(file.substring(0, 3).toLowerCase(), (StatusStrategy) Class.forName(pckgname + '.' + file.substring(0, file.length() - 6)).newInstance());                      
                      }
